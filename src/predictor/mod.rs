...
impl Predictor {
    ...
    pub fn encode(&self, word: &str) -> String {
        ...
        let encoded = self.encoder.encode(word);
        encoded
    }
...
pub fn load_default_english_words() -> Vec<String> {
    ...
    vec![
        ...
        "us", "function", "let", "var", "const", "return", "if", "else",
        "for", "while", "true", "false", "null", "undefined", "string",
        "number", "object", "array", "test", "run", "build", "error",
        "type", "struct", "enum", "impl", "trait", "pub", "fn", "mut",
...
mod tests {
    ...
    fn setup_predictor() -> Predictor {
        ...
        p.build_index([
            ...
            "there", "their", "they're", "wear", "where", "were",
        ]);
        p
    }
